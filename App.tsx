              ...
              <div className="max-w-5xl mx-auto">
                         ...
                         <div className="pt-2">
                            <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                               <div 
                                  ...
                                  style={{ width: `${Math.min(100, (selectedSubject.chapters.reduce((sum, c) => sum + c.repetitions, 0) / 100) * 100)}%` }}
                                />
                            </div>
                            <p className="text-[10px] text-slate-400 mt-1 font-bold">REPETITION CHALLENGE: 100 REPS GOAL</p>
                         </div>
                      </div>
                    </div>
                ...
                {activeTab === 'settings' && selectedSubject && (
                  <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <div>
                      <h3 className="text-xl font-bold text-slate-800 mb-6">Subject Settings</h3>
                      <div className="space-y-6">
                        <div>
                          <label className="block text-sm font-bold text-slate-700 mb-2">Upcoming Exam Date</label>
                          <input 
                            type="date" 
                            className="w-full md:w-64 border border-slate-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none bg-slate-50"
